...
<div class="page-title">
    <h2><i class="icon-desktop color"></i> Profile <small>Subtext for header</small></h2>
    <hr />
</div>
<!-- Page title -->
    ...
    <div class="awidget-body">
        <div class="row">
            <div class="col-md-3 col-sm-3">
                <a href="#"><img style=" text-align: center; height:200px;" src='<?php echo base_url()?>assets/img/user.jpg' class="img-thumbnail img-circle img-responsive" alt="" /></a>
            </div>
            <div class="col-md-9 col-sm-9">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>Chitranjan Thakur</td>
                    </tr>
                    <tr>
                        <td><strong>Email</strong></td>
                        <td>:</td>
                        <td>chitranjan@gmail.com</td>
                    </tr>
                    <tr>
                        <td><strong>username</strong></td>
                        <td>:</td>
                        <td>chitranjan Thakur>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>www.crontech.in<br/>www.dranjanakalia.com<br/>www.indiashoponnet.com<br/></td>
                    </tr>
